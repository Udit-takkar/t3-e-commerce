            ...
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-between h-full">
                <div className="flex-shrink-0 flex items-center h-full">
                  <div className="my-auto max-w-[215px] mt-2">
                    <Image
                      onClick={() => router.push("/")}
                ...
                <div className="hidden sm:block sm:ml-6">
                  <div className="flex  items-center">
                    ...
                    {loggedInUser
                      ...
                      : unauthenticatedNav.map((item, index) => (
                          <Link key={item.name} href={item.href}>
                            <a
                              onMouseEnter={() => setHoveredIndex(index)}
                              onMouseLeave={() => setHoveredIndex(null)}
                              className="relative rounded-xl px-4 py-2 text-sm text-gray-500 transition-all delay-150 hover:text-gray-900"
                            >
                              <AnimatePresence>
                                {hoveredIndex === index && (
                                  <motion.span
                              ...
                              <span className="font-medium cursor-pointer relative z-10">
                                {item.name}
                              </span>
                            </a>
                          </Link>
